...
void opcontrol() {
	...
	while (true) {
        ...
        if (master.get_digital_new_press(pros::E_CONTROLLER_DIGITAL_L1)) { intake.move(127);}
        if (master.get_digital_new_press(pros::E_CONTROLLER_DIGITAL_L2)) { intake.move(-127);}
